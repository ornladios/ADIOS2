...
#undef declare_type
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "SelectionSize",
...
#undef declare_type
    ...
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "Count",
...
size_t VariableNT::AddOperation(const Operator op, const Params &parameters)
{
    ...
    if (!op)
    {
        helper::Throw<std::invalid_argument>("bindings::CXX", "VariableNT", "AddOperation",
                                             "invalid operation");
    }
...
size_t VariableNT::StructFields() const
{
    ...
    {
        helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "StructFields",
...
std::string VariableNT::StructFieldName(const size_t index) const
{
    ...
    if (m_Variable->m_Type != DataType::Struct)
    {
        helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "StructFieldName",
                                          "invalid data type " + ToString(m_Variable->m_Type) +
                                              ", only Struct type supports this API");
    }
    if (reinterpret_cast<core::VariableStruct *>(m_Variable)->m_ReadStructDefinition)
...
size_t VariableNT::StructFieldOffset(const size_t index) const
{
    ...
    if (m_Variable->m_Type != DataType::Struct)
    {
        helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "StructFieldOffset",
                                          "invalid data type " + ToString(m_Variable->m_Type) +
                                              ", only Struct type supports this API");
    }
    if (reinterpret_cast<core::VariableStruct *>(m_Variable)->m_ReadStructDefinition)
...
DataType VariableNT::StructFieldType(const size_t index) const
{
    ...
    if (m_Variable->m_Type != DataType::Struct)
    {
        helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "StructFieldType",
                                          "invalid data type " + ToString(m_Variable->m_Type) +
                                              ", only Struct type supports this API");
    }
    if (reinterpret_cast<core::VariableStruct *>(m_Variable)->m_ReadStructDefinition)
...
size_t VariableNT::StructFieldElementCount(const size_t index) const
{
    ...
    if (m_Variable->m_Type != DataType::Struct)
    {
        helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "StructFieldElementCount",
                                          "invalid data type " + ToString(m_Variable->m_Type) +
                                              ", only Struct type supports this API");
    }
    if (reinterpret_cast<core::VariableStruct *>(m_Variable)->m_ReadStructDefinition)
...
VariableNT::T VariableNT::Min(const size_t step) const
{
    ...
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "Min",
                                      "invalid data type " + ToString(m_Variable->m_Type) +
...
VariableNT::T VariableNT::Max(const size_t step) const
{
    ...
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "Max",
                                      "invalid data type " + ToString(m_Variable->m_Type) +
                                          ", only basic numeric types support this API");
    return {0};
}
...
double VariableNT::MinDouble(const size_t step) const
{
    ...
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "MinDouble",
                                      "invalid data type " + ToString(m_Variable->m_Type) +
                                          ", only basic numeric types support this API");
    return 0;
}
...
double VariableNT::MaxDouble(const size_t step) const
{
    ...
    helper::Throw<std::runtime_error>("bindings::CXX", "VariableNT", "MaxDouble",
                                      "invalid data type " + ToString(m_Variable->m_Type) +
                                          ", only basic numeric types support this API");
    return 0;
}
