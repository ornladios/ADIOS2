...
namespace pybind11 {
namespace detail {
template <> struct type_caster<adios2::py11::MPI4PY_Comm> {
public:
  /**
...
PYBIND11_MODULE(ADIOS2_PYTHON_MODULE_NAME, m) {
  ...
  pybind11::class_<adios2::py11::IO>(m, "IO")
      ...
      .def("DefineVariable",
           (adios2::py11::Variable(adios2::py11::IO::*)(
               ...
               const adios2::Dims &, const adios2::Dims &, const adios2::Dims &,
               const bool)) &
  ...
  pybind11::class_<adios2::py11::Engine>(m, "Engine")
      ...
      .def("BeginStep",
           (adios2::StepStatus(adios2::py11::Engine::*)(const adios2::StepMode,
                                                        const float)) &
  ...
  pybind11::class_<adios2::py11::File>(m, "File")
      .def("__repr__",
           [](const adios2::py11::File &stream) {
             return "<adios2.file named '" + stream.m_Name + "' and mode '" +
                    stream.m_Mode + "'>";
           })
      ...
      .def("write",
           (void(adios2::py11::File::*)(
               const std::string &, const pybind11::array &,
               const adios2::Dims &, const adios2::Dims &, const adios2::Dims &,
               const adios2::vParams &, const bool)) &
               adios2::py11::File::Write,
           pybind11::arg("name"), pybind11::arg("array"),
      ...
      .def("write_attribute",
           ...
           pybind11::arg("name"), pybind11::arg("array"),
           pybind11::arg("variable_name") = "",
           pybind11::arg("separator") = "/", pybind11::arg("end_step") = false,
           R"md(
             writes a self-describing single value array (numpy) variable
      ...
      .def("read_string",
           (std::vector<std::string>(adios2::py11::File::*)(const std::string &,
                                                            const size_t)) &
