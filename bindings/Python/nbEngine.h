...
public:
    ...
    nb::bytes GetMetadata();

    StepStatus BeginStep(const StepMode mode, const float timeoutSeconds = -1.f);
    StepStatus BeginStep();

    void Put(Variable variable, const nb::ndarray<nb::numpy> &array,
    ...
    void Get(Variable variable, nb::ndarray<nb::numpy> &array, const Mode launch = Mode::Deferred);
    // function for cupy, numpy and Tensor pointers
