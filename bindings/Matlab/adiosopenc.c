...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    const char *top_field_names[] = {"Name", "Handlers", "Variables", "Attributes"}; /* top level struct fields */
    mwSize ntopfields = 4;
    ...
    const char *handler_field_names[] = {"FileHandler", "GroupHandler", "ADIOSHandler"}; /* handler level struct fields */
    ...
    const char *var_field_names[] = {"Name","Type","Dims", "StepsStart", "StepsCount", "GlobalMin", "GlobalMax"}; /* variable level struct fields */
    mwSize nvarfields = 7;
    ...
    if (verbose) mexPrintf("Create top.Handlers struct array, 1-by-1\n");
    ...
    if (verbose) mexPrintf("Create top.Variables struct array, 1-by-%zu\n", nvars);
    var_struct_dims[0] = 1;
    ...
    if (verbose) mexPrintf("Create top.Attributes struct array, 1-by-%zu\n", nattrs);
