...
adios2_io *adios2_declare_io(adios2_adios *adios, const char *io_name)
{
    ...
    adios2_io *io = reinterpret_cast<adios2_io *>(
        &reinterpret_cast<adios2::ADIOS *>(adios)->DeclareIO(io_name));
    return io;
}

adios2_io *adios2_at_io(adios2_adios *adios, const char *io_name)
{
    adios2::CheckForNullptr(adios, "for adios2_adios, in call to adios2_at_io");
    adios2_io *io = reinterpret_cast<adios2_io *>(
        &reinterpret_cast<adios2::ADIOS *>(adios)->AtIO(io_name));
    return io;
}
