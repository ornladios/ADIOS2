...
subroutine adios2_put_ldp(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_1d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_1d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_2d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    real(kind=16), dimension(:, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_2d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    complex(kind=16), dimension(:, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_3d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    real(kind=16), dimension(:, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_3d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    complex(kind=16), dimension(:, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_4d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    real(kind=16), dimension(:, :, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_4d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    complex(kind=16), dimension(:, :, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_5d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    real(kind=16), dimension(:, :, :, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_5d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    complex(kind=16), dimension(:, :, :, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_ldp_6d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    real(kind=16), dimension(:, :, :, :, :, :), intent(in):: data
    integer, intent(in):: launch
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
subroutine adios2_put_complex_ldp_6d(engine, variable, data, launch, ierr)
    type(adios2_engine), intent(in):: engine
    type(adios2_variable), intent(in):: variable
    complex(kind=16), dimension(:, :, :, :, :, :), intent(in):: data
    integer, intent(in):: launch
