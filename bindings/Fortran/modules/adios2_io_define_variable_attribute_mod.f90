...
!
!  adios2_io_define_variable_attribute_mod.f90 : ADIOS2 Fortran bindings for IO class
!  overloaded (C++ template) function adios2_define_variable_attribute
!
!   Created on: Sep 19, 2018
!       Author: William F Godoy godoywf@ornl.gov
!

module adios2_io_define_variable_attribute_mod
    use adios2_parameters_mod
    implicit none

    interface adios2_define_variable_attribute
