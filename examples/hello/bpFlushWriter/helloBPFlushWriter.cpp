 ...
 *
 * helloBPFlushWriter.cpp: Example that tests buffer overflow forcing a flush to
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        adios::IO &bpIO = adios.DeclareIO("BPFile_N2N_Flush");
        ...
        auto bpWriter = bpIO.Open("myVectorFlush.bp", adios::OpenMode::Write);
