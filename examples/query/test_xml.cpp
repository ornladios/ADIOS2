...
int main(int argc, char *argv[])
{
  ...
  try
	...
	std::cout<<" file = "<<configFileName<<std::endl;
      ...
      adios2::ADIOS  ad = adios2::ADIOS(configFileName, MPI_COMM_WORLD, adios2::DebugON);
      ...
      //adios2::query::Worker* w = adios2::query::GetWorker(configFileName, MPI_COMM_WORLD);
	...
	std::cout<<" ... use reader to read out touched blocks ... size="<<touched_blocks.size()<<std::endl;
	reader.EndStep();
      }
