...
if(ADIOS2_USE_ZeroMQ STREQUAL AUTO)
  find_package(ZeroMQ 4.1 CONFIG QUIET)
  if(NOT ZeroMQ_FOUND)
...
if(ADIOS2_USE_SysVShMem)
  ...
  elseif(NOT ADIOS2_USE_SysVShMem STREQUAL AUTO)
    message(FATAL_ERROR "ADIOS2_USE_SysVShMem=ON but SysV shared memory (shmget) is unavailable")
  endif()
endif()
...
if(ADIOS2_USE_Sodium STREQUAL AUTO)
  find_package(Sodium 1.0.4)
elseif(ADIOS2_USE_Sodium)
  find_package(Sodium 1.0.4 REQUIRED)
endif()
if(Sodium_FOUND)
