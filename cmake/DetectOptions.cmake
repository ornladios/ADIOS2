...
if(NOT (CMAKE_CXX_COMPILER_ID STREQUAL "PGI") AND NOT MSVC)
    ...
    elseif(ADIOS2_USE_DataMan)
        if(ZeroMQ_FOUND AND MPI_FOUND)
            ...
            if(NOT ZeroMQ_FOUND)
                message(FATAL_ERROR "DataMan is enabled but ZeroMQ is not found.")
            endif()
            if(NOT MPI_FOUND)
                message(FATAL_ERROR "DataMan is enabled but MPI is not found.")
            endif()
        endif()
    endif()
endif()
...
if(NOT (CMAKE_CXX_COMPILER_ID STREQUAL "PGI") AND NOT MSVC)
    ...
    elseif(ADIOS2_USE_WDM)
        if(ZeroMQ_FOUND AND MPI_FOUND)
            ...
            if(NOT ZeroMQ_FOUND)
                message(FATAL_ERROR "WDM is enabled but ZeroMQ is not found.")
            endif()
            if(NOT MPI_FOUND)
                message(FATAL_ERROR "WDM is enabled but MPI is not found.")
            endif()
        endif()
    endif()
endif()
