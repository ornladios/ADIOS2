...
#ifndef ADIOS2_OPERATOR_COMPRESS_COMPRESSBLOSC2_H_
#define ADIOS2_OPERATOR_COMPRESS_COMPRESSBLOSC2_H_
...
class CompressBlosc2 : public Operator
{
...
public:
     ...
     * Unique constructor
     */
    CompressBlosc2(const Params &parameters);

    ~CompressBlosc2() = default;
     ...
     * @param blockCount
     * @param type
     * @param bufferOut format will be: 'DataHeader ; (Blosc2CompressedChunk |
     * UncompressedData), [ Blosc2CompressedChunk, ...]'
...
#endif /* ADIOS2_OPERATOR_COMPRESS_COMPRESSBLOSC2_H_ */
