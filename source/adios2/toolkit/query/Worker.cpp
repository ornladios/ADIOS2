...
namespace adios2 {
  namespace query {
	...
	bool doOverWrite = ToBoolValue(input, adios2::BlockIndexBuilder.m_ParamOverWrite);
	size_t blockSize = ToUIntValue(input, adios2::BlockIndexBuilder.m_ParamBlockSize, 2000000);
    ...
    */
    ...
    {
      std::cout<<"  will evaluate shifting  in output region later  .."<<std::endl;
      touchedBlocks.clear();
