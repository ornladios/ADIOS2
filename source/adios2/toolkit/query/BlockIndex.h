...
#include "Index.h"
 ...
 namespace adios2 
 {
   ...
   template <class T>
     ...
     public:
       BlockIndex<T>(adios2::core::Variable<T>& var, adios2::core::IO& io, adios2::core::Engine& reader)
	 ...
	 std::vector<typename adios2::core::Variable<T>::Info> varBlocksInfo = m_IdxReader.BlocksInfo(m_Var, currStep);
       ...
       void SetContent(const QueryVar& query, int ts);
