...
namespace adios2 
{
  ...
  {    
    ...
    public:
      ...
      adios2::core::Engine*  GetSourceReader()
    ...
    static Worker* GetWorker(const std::string& configFile, adios2::core::Engine* adiosEngine) 
    {
      std::ifstream fileStream(configFile);
      
      if (!fileStream)
	throw std::ios_base::failure("ERROR: file " + configFile +  " not found. ");
