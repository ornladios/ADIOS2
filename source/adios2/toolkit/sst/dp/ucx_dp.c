...
extern NO_SANITIZE_THREAD CP_DP_Interface LoadUcxDP()
{
    ...
    UcxDPInterface.readRemoteMemory = (CP_DP_ReadRemoteMemoryFunc)UcxReadRemoteMemory;
    UcxDPInterface.waitForCompletion = UcxWaitForCompletion;
    UcxDPInterface.notifyConnFailure = UcxNotifyConnFailure;
    UcxDPInterface.provideTimestep = (CP_DP_ProvideTimestepFunc)UcxProvideTimestep;
    UcxDPInterface.readerRegisterTimestep = NULL;
    UcxDPInterface.releaseTimestep = (CP_DP_ReleaseTimestepFunc)UcxReleaseTimestep;
    ...
    UcxDPInterface.timestepArrived = (CP_DP_ReaderTimestepArrivalFunc)UcxTimestepArrived;
