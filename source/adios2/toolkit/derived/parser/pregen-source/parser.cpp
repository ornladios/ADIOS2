...
#line 144 "parser.cpp"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      case symbol_kind::S_DOUBLE: // "number"
...
#line 694 "parser.cpp"
  ...
  case 8: // exp: "number"
#line 74 "../parser.y"
           { drv.createNode(yystack_[0].value.as < double > ()); }
#line 700 "parser.cpp"
    break;

  case 9: // exp: INT
#line 75 "../parser.y"
      { drv.createNode(yystack_[0].value.as < int > ()); }
#line 706 "parser.cpp"
    break;

  case 10: // exp: exp OPERATOR exp
#line 76 "../parser.y"
...
#line 736 "parser.cpp"
  ...
  case 15: // indices_list: %empty
#line 85 "../parser.y"
         { yylhs.value.as < std::vector<std::tuple<int, int, int>> > () = {}; }
#line 742 "parser.cpp"
    break;

  case 16: // indices_list: indices_list "," index
#line 86 "../parser.y"
...
#line 848 "parser.cpp"
  ...
  "]", "OPERATOR", "identifier", "VARNAME", "number", "INT", "$accept",
  "lines", "assignment", "exp", "indices_list", "index", "list", YY_NULLPTR
    };
...
#undef YYCASE_
  ...
  parser::yypact_[] =
  {
       7,    11,    25,   -10,   -10,     5,     7,    -9,    30,     9,
      -4,    11,    -3,   -10,   -10,    11,   -10,    18,    33,    19,
      27,    -2,    37,     0,   -10,   -10,    -3,    -3,    11,   -10,
      29,    39,     1,    -3,   -10,    26,    28,   -10,   -10,    31,
      32,    42,   -10,   -10,   -10,   -10,   -10,    34,   -10
  };

  const signed char
  parser::yydefact_[] =
  {
       0,     0,    14,     8,     9,     0,     0,     3,    14,     0,
       0,    30,    15,     1,     2,     0,    11,     5,     4,    32,
       0,     0,    29,     0,    17,    10,    15,    15,    30,    12,
       0,    26,    28,    18,    13,     0,     0,    31,    24,    25,
      27,    23,    16,     7,     6,    20,    21,    22,    19
  };
  ...
  parser::yytable_[] =
  {
       9,    15,    21,    30,    33,    13,    40,    17,    18,    34,
      19,    22,    31,     1,    25,    41,    16,     1,     2,    15,
       3,     4,     8,    28,     3,     4,    26,    19,    10,    15,
      33,    11,    33,    12,    29,    43,    11,    44,    12,    35,
      36,    27,    32,    38,    39,    45,    46,    47,    48,    14,
      42,    37
  };
  ...
  parser::yycheck_[] =
  {
       1,    10,     5,     5,     4,     0,     5,    11,    12,     9,
      11,    14,    14,     6,    15,    14,     7,     6,    11,    10,
      13,    14,    11,     4,    13,    14,     8,    28,     3,    10,
       4,     6,     4,     8,     7,     9,     6,     9,     8,    26,
      27,     8,     5,    14,     5,    14,    14,     5,    14,     6,
      33,    28
  };
  ...
  parser::yystos_[] =
  {
       0,     6,    11,    13,    14,    16,    17,    18,    11,    18,
       3,     6,     8,     0,    16,    10,     7,    11,    12,    18,
      21,     5,    14,    19,    20,    18,     8,     8,     4,     7,
       5,    14,     5,     4,     9,    19,    19,    21,    14,     5,
       5,    14,    20,     9,     9,    14,    14,     5,    14
  };
