...
std::vector<std::string> BP4Base::GetBPMetadataFileNames(
...
std::string
BP4Base::GetBPMetadataFileName(const std::string &name) const noexcept
{
...
std::string
BP4Base::GetBPMetadataIndexFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
...
std::vector<std::string> BP4Base::GetBPVersionFileNames(
    const std::vector<std::string> &names) const noexcept
{
...
std::string
BP4Base::GetBPVersionFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
...
std::vector<std::string> BP4Base::GetBPActiveFlagFileNames(
    const std::vector<std::string> &names) const noexcept
{
    std::vector<std::string> metadataIndexFileNames;
    metadataIndexFileNames.reserve(names.size());
...
std::string
BP4Base::GetBPActiveFlagFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
    /* the name of the metadata index file is "md.idx" */
    const std::string bpMetaDataIndexRankName(bpName + PathSeparator +
...
std::vector<std::string> BP4Base::GetBPSubStreamNames(
    const std::vector<std::string> &names) const noexcept
{
