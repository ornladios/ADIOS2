...
#ifndef ADIOS2_TOOLKIT_FORMAT_BP3_OPERATION_BP3MGARD_TCC_
#define ADIOS2_TOOLKIT_FORMAT_BP3_OPERATION_BP3MGARD_TCC_
...
template <class T>
void BP3MGARD::SetMetadataCommon(
    const core::Variable<T> &variable,
    const typename core::Variable<T>::Info &blockInfo,
    const typename core::Variable<T>::Operation &operation,
...
template <class T>
void BP3MGARD::UpdateMetadataCommon(
    const core::Variable<T> &variable,
    const typename core::Variable<T>::Info &blockInfo,
    const typename core::Variable<T>::Operation &operation,
    std::vector<char> &buffer) const noexcept
...
#endif /* ADIOS2_TOOLKIT_FORMAT_BP3_OPERATION_BP3MGARD_TCC_ */
