...
template <class T>
inline void
BP4Serializer::PutVariableMetadata(const core::Variable<T> &variable) noexcept
{
...
template <class T>
inline void
BP4Serializer::PutVariablePayload(const core::Variable<T> &variable) noexcept
{
    ProfilerStart("buffering");
...
// PRIVATE
template <class T>
size_t BP4Serializer::PutAttributeHeaderInData(const core::Attribute<T> &attribute,
                                               Stats<T> &stats) noexcept
{
    ...
    helper::CopyToBuffer(buffer, position, &no); // not associated with a Variable
...
inline void BP4Serializer::PutAttributeCharacteristicValueInIndex(
    uint8_t &characteristicsCounter, const core::Attribute<std::string> &attribute,
                                        ...
                                        const Stats<T> &stats) noexcept
{
    ...
    helper::CopyToBuffer(buffer, backPosition, &characteristicsCounter); // count (1)
    ...
    helper::CopyToBuffer(buffer, backPosition, &characteristicsLength); // length
...
template <>
inline BP4Serializer::Stats<typename TypeInfo<std::string>::ValueType>
BP4Serializer::GetStats(const core::Variable<std::string> &variable) noexcept
{
...
template <class T>
BP4Serializer::Stats<typename TypeInfo<T>::ValueType>
BP4Serializer::GetStats(const core::Variable<T> &variable) noexcept
{
    ...
    if (m_StatsLevel == 0)
    {
        ...
        helper::GetMinMaxThreads(variable.GetData(), valuesSize, stats.Min, stats.Max,
                         m_Threads);
        ProfilerStop("minmax");
    }
    stats.Step = m_MetadataSet.TimeStep;
...
template <class T>
void BP4Serializer::PutBoundsRecord(const bool isScalar, const Stats<T> &stats,
...
inline void BP4Serializer::PutPayloadInBuffer(
    const core::Variable<std::string> &variable) noexcept
{
...
template <class T>
void BP4Serializer::PutPayloadInBuffer(const core::Variable<T> &variable) noexcept
{
    ProfilerStart("memcpy");
    helper::CopyToBufferThreads(m_Data.m_Buffer, m_Data.m_Position, variable.GetData(),
