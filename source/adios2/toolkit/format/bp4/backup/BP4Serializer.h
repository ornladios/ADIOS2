...
public:
     ...
     */
    template <class T>
    void PutVariableMetadata(const core::Variable<T> &variable) noexcept;
     ...
     */
    template <class T>
    void PutVariablePayload(const core::Variable<T> &variable) noexcept;
...
private:
    ...
    template <class T>
    void
    PutAttributeLengthInData(const core::Attribute<T> &attribute, Stats<T> &stats,
    ...
    GetStats(const core::Variable<T> &variable) noexcept;
     ...
     */
    template <class T>
    void PutPayloadInBuffer(const core::Variable<T> &variable) noexcept;
...
#define declare_template_instantiation(T)                                      \
    extern template void BP4Serializer::PutVariablePayload(                    \
        const core::Variable<T> &variable) noexcept;                                 \
                                                                               \
