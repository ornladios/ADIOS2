...
#ifndef ADIOS2_TOOLKIT_FORMAT_BP4_OPERATION_BP4SZ_TCC_
#define ADIOS2_TOOLKIT_FORMAT_BP4_OPERATION_BP4SZ_TCC_
...
template <class T>
void BP4SZ::UpdateMetadataCommon(
    const core::Variable<T> &variable,
    const typename core::Variable<T>::Info &blockInfo,
    const typename core::Variable<T>::Operation &operation,
    std::vector<char> &buffer) const noexcept
...
#endif /* ADIOS2_TOOLKIT_FORMAT_BP4_OPERATION_BP4SZ_H_ */
