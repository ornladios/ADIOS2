...
std::vector<std::string> BP5Engine::GetBPMetadataFileNames(
...
std::string
BP5Engine::GetBPMetadataFileName(const std::string &name) const noexcept
{
...
std::string
BP5Engine::GetBPMetaMetadataFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
    const size_t index = 0; // global metadata file is generated by rank 0
    /* the name of the metadata file is "md.0" */
...
std::string
BP5Engine::GetBPMetadataIndexFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
...
std::vector<std::string> BP5Engine::GetBPVersionFileNames(
    const std::vector<std::string> &names) const noexcept
{
...
std::string
BP5Engine::GetBPVersionFileName(const std::string &name) const noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
