...
DaosEngine::GetBPMetadataFileNames(const std::vector<std::string> &names) const
    noexcept
{
...
std::string DaosEngine::GetBPMetadataFileName(const std::string &name) const
    noexcept
{
...
std::string DaosEngine::GetBPMetaMetadataFileName(const std::string &name) const
    noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
    const size_t index = 0; // global metadata file is generated by rank 0
...
std::vector<std::string>
DaosEngine::GetBPVersionFileNames(const std::vector<std::string> &names) const
    noexcept
{
...
std::string DaosEngine::GetBPVersionFileName(const std::string &name) const
    noexcept
{
    const std::string bpName = helper::RemoveTrailingSlash(name);
