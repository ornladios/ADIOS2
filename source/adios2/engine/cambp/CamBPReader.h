...
#ifndef ADIOS2_ENGINE_CamBP_READER_H_
#define ADIOS2_ENGINE_CamBP_READER_H_
...
class CamBPReader : public Engine
{
...
public:
     ...
     * @param comm
     */
    CamBPReader(IO &io, const std::string &name, const Mode mode,
              helper::Comm comm);

    virtual ~CamBPReader() = default;
...
#endif /* ADIOS2_ENGINE_CamBP_READER_H_ */
