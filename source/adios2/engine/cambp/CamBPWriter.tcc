 ...
 *
 * CamBPWriter.tcc implementation of template functions with known type
 *
 *  Created on: Aug 1, 2018
 *      Author: Lipeng Wan wanl@ornl.gov
 */
#ifndef ADIOS2_ENGINE_CamBP_WRITER_TCC_
#define ADIOS2_ENGINE_CamBP_WRITER_TCC_
...
template <class T>
void CamBPWriter::PutCommon(Variable<T> &variable,
...
template <class T>
void CamBPWriter::PutSyncCommon(Variable<T> &variable,
                              const typename Variable<T>::Info &blockInfo,
                              const bool resize)
{
...
template <class T>
void CamBPWriter::PutDeferredCommon(Variable<T> &variable, const T *data)
{
...
template <class T>
T *CamBPWriter::BufferDataCommon(const size_t payloadPosition,
...
template <class T>
void CamBPWriter::PerformPutCommon(Variable<T> &variable)
{
...
#endif /* ADIOS2_ENGINE_CamBP_WRITER_TCC_ */
