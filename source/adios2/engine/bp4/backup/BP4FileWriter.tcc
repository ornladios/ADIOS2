...
{
template <class T>
void BP4FileWriter::PutSyncCommon(Variable<T> &variable, const T *values)
{
    // set variable
    ...
    format::BP4Base::ResizeResult resizeResult = m_BP4Serializer.ResizeBuffer(
    ...
    m_BP4Serializer.PutVariableMetadata(variable);
    m_BP4Serializer.PutVariablePayload(variable);
}

template <class T>
void BP4FileWriter::PutDeferredCommon(Variable<T> &variable, const T *values)
{
    variable.SetData(values);
    m_BP4Serializer.m_DeferredVariables.push_back(variable.m_Name);
