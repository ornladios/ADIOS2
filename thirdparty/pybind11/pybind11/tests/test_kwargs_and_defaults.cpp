...
TEST_SUBMODULE(kwargs_and_defaults, m)
{
    ...
    m.def("kw_func3", [](const char *) {},
          py::arg("data") = std::string("Hello world!"));
    ...
    auto mixed_plus_both = [](int i, double j, py::args args,
                              py::kwargs kwargs) {
    ...
    // pybind11 won't allow these to be bound: args and kwargs, if present, must
    // be at the end.
