...
TEST_SUBMODULE(pytypes, m)
{
    ...
    m.def("str_from_object",
          [](const py::object &obj) { return py::str(obj); });
    m.def("repr_from_object",
          [](const py::object &obj) { return py::repr(obj); });
    ...
    m.def("return_capsule_with_name_and_destructor", []() {
        auto capsule = py::capsule(
            (void *)1234, "pointer type description", [](PyObject *ptr) {
                if (ptr)
                {
        ...
        py::print("created capsule ({}, '{}')"_s.format((size_t)contents,
                                                        capsule.name()));
        return capsule;
    });
    ...
    m.def("default_constructors", []() {
        return py::dict("str"_a = py::str(), "bool"_a = py::bool_(),
    ...
    m.def("cast_functions", [](py::dict d) {
        // When converting between Python types, obj.cast<T>() should be the
        // same as T(obj)
        return py::dict("str"_a = d["str"].cast<py::str>(),
                        ...
                        "memoryview"_a =
                            d["memoryview"].cast<py::memoryview>());
    });
    ...
    m.def("print_function", []() {
        ...
        py::print("{a} + {b} = {c}"_s.format(
            "a"_a = "py::print", "b"_a = "str.format", "c"_a = "this"));
    });
