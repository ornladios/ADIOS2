...
// We get some really long type names here which causes MSVC 2015 to emit
// warnings
...
/// Dummy type which is not exported anywhere -- something to trigger a
/// conversion error
...
/// Like UserType, but increments `value` on copy for quick reference vs. copy
/// tests
...
/// Custom cast-only type that casts to a string "rvalue" or "lvalue" depending
/// on the cast context.
