...
public:
        ...
        return_value_policy /* policy */, handle /* parent */)
    {
        ...
        // this function uses static memory so it's best to copy it out asap
        // just in case
        // otherwise other code that is using localtime may break this (not just
        // python code)
...
// since they are not measured on calendar time. So instead we just make them
// timedeltas
