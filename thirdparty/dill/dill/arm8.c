...
extern void arm8_dproc2(dill_stream s, int op, int fop, int dest, int src)
{
    if (op == RSB) {
...
extern void arm8_negf(dill_stream s, int op, int fd, int dest, int src)
{
    arm8_fproc2(s, op, fd, 0, dest, src);
}

extern void arm8_fproc2(dill_stream s, int op, int fd, int n, int dest, int src)
{
...
extern void arm8_fproc(dill_stream s, int arm8_op, int fd, int dest, int src1, int src2)
{
...
extern void
arm8_package_end(dill_stream s)
{
    arm8_nop(s);
    arm8_simple_ret(s);
    arm8_PLT_emit(s, 1);
...
extern void *
arm8_clone_code(dill_stream s, void *new_base, int available_size)
{
...
extern void
arm8_set(dill_stream s, int r, long val)
{
...
extern void*
gen_arm8_mach_info(dill_stream s, int v9)
{
