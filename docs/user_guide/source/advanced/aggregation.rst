...
The implementation of rerouting aggregation in ADIOS2 was inspired by and based on the `paper <https://ieeexplore.ieee.org/document/8540017>`_ "Can I/O Variability Be Reduced on QoS-Less HPC Storage Systems?".
