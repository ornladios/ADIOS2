...
# Spectrum MPI has known issues with SSC
ADIOS2_USE_SSC:BOOL=OFF

# We can't support multiple simultaneous jsruns and the mpmd wrapper
ADIOS2_RUN_STAGING_NONMPMD_TESTS:BOOL=OFF

MPIEXEC_EXECUTABLE:FILEPATH=${JSRUN_EXECUTABLE}
MPIEXEC_MAX_NUMPROCS:STRING=12
MPIEXEC_EXTRA_FLAGS:STRING=-r1 -a6 -gALL_GPUS -cALL_CPUS -d cyclic -n2 $ENV{EXTERNAL_WORKDIR}/build/bin/mpmd-wrapper.sh JSM_NAMESPACE_RANK
