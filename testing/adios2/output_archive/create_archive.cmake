...
file(GLOB files_to_archive LIST_DIRECTORIES false "${SOURCE_DIR}/*")
...
execute_process (COMMAND bash -c "rm -f ${SOURCE_DIR}.zip; zip -qX ${SOURCE_DIR}.zip ${files_no_semi}" WORKING_DIRECTORY ${SOURCE_DIR})
