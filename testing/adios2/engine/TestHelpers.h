...
inline SmallTestData generateNewSmallTestData(SmallTestData in, size_t step, size_t rank,
                                              size_t size)
{
...
inline void UpdateSmallTestData(SmallTestData &in, int step, int rank, int size)
{
