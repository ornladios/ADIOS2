...
function(MutateTestSet out_list name param in_list )
  ...
  FOREACH (basename ${in_list})
    ...
    message(STATUS "New command is ${tmp_cmd}\n")
    set(${modname}_CMD ${tmp_cmd} PARENT_SCOPE)
    message( STATUS "Establishing command ${modname}_CMD")
    if (NOT "${${basename}_TIMEOUT}" STREQUAL "") 
        message (STATUS "ACTUAL TIMEOUT SET for ${basename}_TIMEOUT, ${${basename}_TIMEOUT}")
