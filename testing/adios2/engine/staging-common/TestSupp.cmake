...
if(ADIOS2_RUN_STAGING_NONMPMD_TESTS)
...
function(MutateTestSet out_list name participant param in_list )
  if(STAGING_COMMON_TEST_SUPP_VERBOSE)
    message(STATUS "MTS0:")
    message(STATUS "     out_list: \"${out_list}\"")
    message(STATUS "         name: \"${name}\"")
    message(STATUS "  participant: \"${participant}\"")
    message(STATUS "        param: \"${param}\"")
    message(STATUS "      in_list: \"${in_list}\"")
  endif()
  set(tmp_list "")
  foreach(basename IN LISTS in_list)
    set(modname "${basename}.${name}")
    if(STAGING_COMMON_TEST_SUPP_VERBOSE)
      message(STATUS "MTS1: modname: \"${modname}\"")
    endif()
    if("${${basename}_CMD}" STREQUAL "") 
      if(STAGING_COMMON_TEST_SUPP_VERBOSE)
        message(STATUS "MTS1: Skipping test ${modname}")
      endif()
      continue()
    endif()
  ...
  endforeach()
  if(STAGING_COMMON_TEST_SUPP_VERBOSE)
    message(STATUS "MTS0: Setting ${out_list} to ${tmp_list}")
  endif()
...
function(add_common_test basename engine)
    ...
    if("${${basename}_CMD}" STREQUAL "") 
      if(STAGING_COMMON_TEST_SUPP_VERBOSE)
        message(STATUS "ACT0: Skipping test ${testname}")
      endif()
      return()
    endif()
    ...
    if(STAGING_COMMON_TEST_SUPP_VERBOSE)
      message(STATUS "ACT0: Adding test \"${testname}\" COMMAND \"${command}\"")
    endif()
