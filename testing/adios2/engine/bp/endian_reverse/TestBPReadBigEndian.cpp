...
#define adios2_str(X) str_helper(X)

class BPReadBigEndian : public ::testing::Test
{
public:
    BPReadBigEndian() : configDir(adios2_str(BIG_ENDIAN_DIR)){};

    SmallTestData m_TestData;
    std::string configDir;
};

TEST_F(BPReadBigEndian, BPReadBigEndian1D8)
{
    const std::string fname(configDir + std::string(&adios2::PathSeparator, 1) +
                            "BigEndian1D8.bp");
...
TEST_F(BPReadBigEndian, BPReadBigEndian2D2x4)
{
...
TEST_F(BPReadBigEndian, BPReadBigEndian2D4x2)
{
