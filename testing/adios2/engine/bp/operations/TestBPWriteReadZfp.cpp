...
class BPWriteReadZfp : public ::testing::Test
{
public:
    BPWriteReadZfp() = default;
};

TEST_F(BPWriteReadZfp, ADIOS2BPWriteRead1D)
{
...
TEST_F(BPWriteReadZfp, ADIOS2BPWriteRead2D)
{
    // Each process would write a 1x8 array and all processes would
    // form a mpiSize * Nx 1D array
...
TEST_F(BPWriteReadZfp, ADIOS2BPWriteRead3D)
{
    // Each process would write a 1x8 array and all processes would
    // form a mpiSize * Nx 1D array
