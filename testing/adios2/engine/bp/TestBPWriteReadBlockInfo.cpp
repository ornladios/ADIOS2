...
TEST_F(BPWriteReadBlockInfo, BPWriteReadBlockInfo2D4x2)
{
    const std::string fname("BPWriteReadBlockInfo2D4x2.bp");
...
TEST_F(BPWriteReadBlockInfo, BPWriteReadBlockInfo2D4x2_ReadMultiSteps)
{
    // Each process would write a 4x2 array and all processes would
    // form a 2D 4 * (NumberOfProcess * Nx) matrix where Nx is 2 here
    const std::string fname("BPWriteReadBlockInfo2D4x2_MultiSteps.bp");
...
TEST_F(BPWriteReadBlockInfo, ReadStartCountBlockInfo)
{
    const std::string fname("ReadStartCountBlockInfo.bp");
