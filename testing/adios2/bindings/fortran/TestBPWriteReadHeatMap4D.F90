program TestBPWriteReadHeatMap4D
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
  allocate (temperatures_r16(in1, in2, in3, in4))
#endif
  temperatures_i1 = 1
  temperatures_i2 = 1
  temperatures_i4 = 1
  ...
  if (irank == 0) then
    ...
    call adios2_set_selection(var_temperaturesIn(6), 4, sel_start, sel_count, &
                              ierr)
#ifdef ADIOS2_HAVE_Fortran_REAL16
    call adios2_set_selection(var_temperaturesIn(7), 4, sel_start, sel_count, &
                              ierr)
#endif
...
#ifdef ADIOS2_HAVE_Fortran_REAL16
    if (sum(sel_temperatures_r16) /= 10000*isize) stop 'Test failed real*16'
#endif
