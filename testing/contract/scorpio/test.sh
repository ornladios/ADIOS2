...
diff -u 0.dump ${source_dir}/../adios2-source/testing/contract/scorpio/0.dump

bpls -d example3_1.nc.bp.dir/example3_1.nc.bp.1 > 1.dump
diff -u 1.dump ${source_dir}/../adios2-source/testing/contract/scorpio/1.dump

bpls -d example3_1.nc.bp.dir/example3_1.nc.bp.2 > 2.dump
diff -u 2.dump ${source_dir}/../adios2-source/testing/contract/scorpio/2.dump

bpls -d example3_1.nc.bp.dir/example3_1.nc.bp.3 > 3.dump
diff -u 3.dump ${source_dir}/../adios2-source/testing/contract/scorpio/3.dump
